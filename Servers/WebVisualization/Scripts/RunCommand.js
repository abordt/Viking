...
function processGraph() {
    ...
    for (var i = 1; i < nodesLength; i++) {
        ...
        if (nodes.item(i).getAttribute("class") == "node") {
            ...
            var type = nodes.item(i).getElementsByTagName('a')[0].getAttribute("xlink:title").toString().split(',')[1];
...
function saveJPG()
{
    ...
    document.getElementById("saveJPGReady").src = mat + "Content/ajax-loader.gif";
...
function savePNG()
{
    ...
    document.getElementById("savePNGLink").style.visibility = "visible"; 
        document.getElementById("savePNGReady").src = mat + "Content/ajax-loader.gif";
...
function savePDF()
{
    ...
    document.getElementById("savePDFReady").src = mat + "Content/ajax-loader.gif";
...
function saveDOT() {
    ...
    document.getElementById("saveDOTReady").src = mat + "Content/ajax-loader.gif";
...
function saveSVG()
{
   var  mat = getPath();
    ...
    document.getElementById("saveSVGReady").src = mat + "Content/ajax-loader.gif";
...
function post_to_url(str, type) {
    ...
    xmlHttp.onreadystatechange = function(){
     ...
     if (xmlHttp.readyState == 4 && xmlHttp.status == 200)
        ...
        document.getElementById("save"+type+ "Ready").src = mat + "Content/icons/arrow_b_d.png";
